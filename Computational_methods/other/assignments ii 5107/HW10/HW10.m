...
load 'C:\Documents and Settings\goober\Desktop\hw10_1_train';
...
load 'C:\Documents and Settings\goober\Desktop\hw10_1_test';   % load test data
...
figure(4);
plot(1:T, kin, 1:T, kin_h, 'r','LineWidth',1.2);
